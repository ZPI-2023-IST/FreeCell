...
class TestCard(TestCase):
    ...
    def test_eq(self):
        ...
        self.assertTrue(card1 == card2)  # Cards with the same rank and suit should be equal
        self.assertFalse(card1 == card3)  # Cards with different suits should not be equal
    ...
    def test_str(self):
        ...
        self.assertEqual(str(card2), '10 + h')